...
export class criaTabelaLocais1672370414723 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "locais" ("id" SERIAL NOT NULL, "local" character varying NOT NULL, "estado" boolean NOT NULL DEFAULT false, "enderecoIP" character varying(255) DEFAULT NULL, "usuario_id" integer, "dispositivo_id" integer, CONSTRAINT "PK_42eaed01557782613d36365d300" PRIMARY KEY ("id"))`);
